---
title: "Mixtape Chapter 1: Probability and Regression Review"
...
output: 
  beamer_presentation:
    ...
    includes:
      in_header: "template/slide_header.tex"
classoption: "aspectratio=169"
---

```{r library, include = FALSE, echo = FALSE}
library(xfun)
xfun::pkg_attach2(c("here", "reticulate"))
```
...
use_python("C:\\Users\\katoo\\Anaconda3\\envs\\econome\\python.exe")
```

```{r chunk_size, include = FALSE, echo = FALSE}
...
## PythonでOLS推定したい：残差と予測値の散布図を描きたい
